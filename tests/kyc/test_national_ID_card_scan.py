...
# Behaviors
@allure.epic("KYC")
@allure.feature("Create a new user account - National ID Scan")
@allure.story("Complete account creation using National ID scanning")
# Suites
@allure.suite(f"version:{VERSION}")
@allure.sub_suite("Tests for National ID Scan")
@allure.severity(allure.severity_level.BLOCKER)
# Links
@allure.link("https://jira.sdb247.com/browse/", name="Jira Task")
def test_national_id_card_scan(open_app_without_login):
